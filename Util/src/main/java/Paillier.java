...
public class Paillier {
    ...
    /**
     * facilitates sending just the encryption method of the current cryptosystem instance
     */
    public Encryptor generate_encryptor(){
        return new Encryptor(bitLength,g,n,nsquare);
    }
